				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/editStudent" id="editfrom" method="post">
							  <div class="form-group ">
							    ...
							    <div class="col-sm-10">
							      <input readonly="readonly" type="text" class="form-control" id="inputEmail3" name="username" placeholder="请输入学号"
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="inputPassword3" name="persname" placeholder="请输入姓名" value="${student.persname}">
							    </div>
							  </div>
							  <div class="form-group">
